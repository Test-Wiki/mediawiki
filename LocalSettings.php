...
$wgAddGroups['sysop'] = array( 'editor', 'reviewer', 'autoreview', 'patroller', 'translateadmin', 'confirmed', 'researcher', 'chatmod', 'blockedfromchat' );
$wgRemoveGroups['sysop'] = array( 'editor', 'reviewer', 'autoreview', 'patroller', 'translateadmin', 'confirmed', 'researcher', 'chatmod', 'blockedfromchat' );
