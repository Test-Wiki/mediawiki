...
$wgGroupPermissions['template-editor']['template-editor'] = true;
$wgGroupPermissions['sysop']['template-editor'] = true;
$wgAddGroups['sysop'] = array( 'editor', 'reviewer', 'autoreview', 'autopatrol', 'patroller', 'translateadmin', 'confirmed', 'researcher', 'chatmod', 'blockedfromchat', 'template-editor' );
$wgRemoveGroups['sysop'] = array( 'editor', 'reviewer', 'autoreview', 'autopatrol', 'patroller', 'translateadmin', 'confirmed', 'researcher', 'chatmod', 'blockedfromchat', 'template-editor' );
...
$wgAddGroups['bureaucrat'] = array( 'bot', 'sysop', 'interface-admin', 'bureaucrat', 'interwiki-admin' );
$wgRemoveGroups['bureaucrat'] = array( 'bot', 'sysop', 'interface-admin', 'bureaucrat', 'interwiki-admin' );
$wgGroupsRemoveFromSelf['sysop'] = array( 'sysop' );
$wgRestrictionLevels = array( '', 'user', 'bureaucrat', 'sysop', 'autoconfirmed', 'steward', 'template-editor' );
